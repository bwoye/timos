...
const myname = document.querySelector('#recedit');

myname.addEventListener('click', getAccName);

function getAccName(ev) {
    ev.preventDefault();
    alert("Am here");
    var projidx = document.getElementById('projid').value;
    const data = { projid: projidx };
    url = 'php/accidentcode.php?projid=' + projidx;
